<!--
**sofiaschanton/sofiaschanton** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
I'm a **Chemical Engineer with a passion for data** — with hands-on experience in **quality assurance and process improvement**, I use data analytics to optimize operations and drive smarter business decisions.

- ⚙️ I bridge the gap between engineering and data: turning operational data into **actionable insights**
- 📈 Background in **quality management and process optimization**, now applied through a data-driven lens
- 🤖 Currently deepening my skills in **machine learning** and **data science workflows**
- 🧗 Outside of data, you'll find me on a **climbing wall** — I love the problem-solving aspect of sport climbing!
...
- 🛒 Building a **Next Purchase Recommendation System** as a final team project at [Henry Bootcamp](https://www.soyhenry.com/) — applying ML to predict what customers will buy next
- 📊 Building end-to-end **data pipelines** and dashboards
- 📚 Continuously learning — currently diving deeper into **MLOps** and **model deployment**
